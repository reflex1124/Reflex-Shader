...
////// Emissive:
                ...
                float3 emissive = saturate((1.0-(1.0-lerp(lerp((node_664_if_leA*node_5282)+(node_664_if_leB*floor(node_5282 * _RimLightSteps) / (_RimLightSteps - 1)),node_5282,node_664_if_leA*node_664_if_leB),float3(node_7427,node_7427,node_7427),(1.0 - _RimLightToggle)))*(1.0-lerp((_Emissive_var.rgb*_EmissiveColor.rgb),float3(node_7427,node_7427,node_7427),(1.0 - _EmissiveToggle)))));
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(i.uv0, _Diffuse));
                ...
                float node_9522 = 0.0;
                float node_5779 = 0.5;
                float node_6221_if_leA = step(_MatCapShadowToggle,node_5779);
                float node_6221_if_leB = step(node_5779,_MatCapShadowToggle);
                float node_18 = 1.0;
                float4 _MatCapShadow_var = tex2D(_MatCapShadow,TRANSFORM_TEX(node_2923, _MatCapShadow));
                float3 node_6221 = lerp((node_6221_if_leA*node_18)+(node_6221_if_leB*_MatCapShadow_var.rgb),node_18,node_6221_if_leA*node_6221_if_leB);
                ...
                float3 finalColor = emissive + (((_Diffuse_var.rgb+lerp(saturate(((_MatCap_var.rgb*_MatCapToggle)*_MatCapColor.rgb)),float3(node_1243,node_1243,node_1243),lerp((node_3219_if_leA*_MatCapMask_var.rgb)+(node_3219_if_leB*node_9522),node_9522,node_3219_if_leA*node_3219_if_leB)))*saturate((node_6221+_MatCapShadowColor.rgb)))*lerp((node_7480_if_leA*((node_1541.r+node_1541.g+node_1541.b)/3.0))+(node_7480_if_leB*node_3930),node_3930,node_7480_if_leA*node_7480_if_leB));
...
////// Lighting:
                ...
                float3 node_3930 = saturate((Function_ShadeSH9( float3(0,1,0) )+CubemapReflections( normalize((_WorldSpaceCameraPos-objPos.rgb)) )+lerp((node_1751_if_leA*_LightColor0.rgb)+(node_1751_if_leB*(attenuation*_LightColor0.rgb)),_LightColor0.rgb,node_1751_if_leA*node_1751_if_leB)));
                float3 node_1541 = node_3930.rgb;
                float3 finalColor = (((_Diffuse_var.rgb+lerp(saturate(((_MatCap_var.rgb*_MatCapToggle)*_MatCapColor.rgb)),float3(node_1243,node_1243,node_1243),lerp((node_3219_if_leA*_MatCapMask_var.rgb)+(node_3219_if_leB*node_9522),node_9522,node_3219_if_leA*node_3219_if_leB)))*saturate((node_6221+_MatCapShadowColor.rgb)))*lerp((node_7480_if_leA*((node_1541.r+node_1541.g+node_1541.b)/3.0))+(node_7480_if_leB*node_3930),node_3930,node_7480_if_leA*node_7480_if_leB));
